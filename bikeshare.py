...
def get_filters():
    ...
    # get user input for city (chicago, new york city, washington). The while loop handles invalid inputs.
    city = ''
    while city =='':
...
def station_stats(df):
    ...
    print('The frequent combination of start station and end station is {}.'.format(df['Start End'].mode()[0]))
